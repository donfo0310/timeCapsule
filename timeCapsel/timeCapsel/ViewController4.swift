...
class ViewController4: UIViewController {
    ...
    @IBAction func sousin(_ sender: AnyObject) {
        ...
        self.userDefaults.set(component.year, forKey: "year1")
        self.userDefaults.set(component.month, forKey: "month1")
        self.userDefaults.set(component.day, forKey: "day1")
        self.userDefaults.set(self.ttext.text, forKey: "Text1")
        self.userDefaults.synchronize()
        var Y=Int(self.userDefaults.string(forKey: "year1")!)
        let M=Int(self.userDefaults.string(forKey: "month1")!)
        let D=Int(self.userDefaults.string(forKey: "day1")!)
        self.ttext.text=""
        self.label2.text=NSLocalizedString("1年後にメッセージを送りました。", comment: "")
        Y=Y!+1
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        label2.text=NSLocalizedString("1年後に届けるメッセージです", comment: "")
        
        if let tt=userDefaults.string(forKey: "Text1"){
            ttext.isHidden=true
            sousint.isHidden=true
            var Y=Int(userDefaults.string(forKey: "year1")!)
            let M=Int(userDefaults.string(forKey: "month1")!)
            let D=Int(userDefaults.string(forKey: "day1")!)
            //var A=0
            Y=Y!+1
            let date1=Date()
