...
class ViewController5: UIViewController {
    ...
    @IBAction func sousin(_ sender: AnyObject) {
        ...
        self.userDefaults.set(component.year, forKey: "year5")
        self.userDefaults.set(component.month, forKey: "month5")
        self.userDefaults.set(component.day, forKey: "day5")
        self.userDefaults.set(self.ttext.text, forKey: "Text5")
        self.userDefaults.synchronize()
        var Y=Int(self.userDefaults.string(forKey: "year5")!)
        let M=Int(self.userDefaults.string(forKey: "month5")!)
        let D=Int(self.userDefaults.string(forKey: "day5")!)
        self.ttext.text=""
        self.label2.text=NSLocalizedString("5年後にメッセージを送りました。", comment: "")
        Y=Y!+5
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        label2.text=NSLocalizedString("5年後に届けるメッセージです", comment: "")
        
        if let tt=userDefaults.string(forKey: "Text5"){
            ttext.isHidden=true
            sousint.isHidden=true
            var Y=Int(userDefaults.string(forKey: "year5")!)
            let M=Int(userDefaults.string(forKey: "month5")!)
            let D=Int(userDefaults.string(forKey: "day5")!)
            //var A=0
            Y=Y!+5
            let date1=Date()
